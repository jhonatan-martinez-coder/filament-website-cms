                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                <div class="blog-img-inner">
                                    <img class="img-fluid w-100 rounded-top" src={{ asset('/storage/'.$tour->thumbnail) }} alt="Image"  
                                        style="height: 400px;">
                                    <div class="blog-icon">
                            ...
                            <div class="blog-content border border-top-0 rounded-bottom p-4">
                                <a href={{ url('/products/' . $tour->id . '/details') }} class="h4 mb-5" style="width: 100%;">{{ $tour->title}}</a>
                                <a href={{ url('/products/' . $tour->id . '/details') }} class="btn btn-primary rounded-pill py-2 px-4 mt-3 text-light" style="width: 100%;">Mas Información</a>
                            </div>
                        </div>
                    </div>
                @endforeach
