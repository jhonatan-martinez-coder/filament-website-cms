...
<head>
    <meta charset="utf-8">
    <title>Trip Tours Cartagena | Paquetes</title>
                    ...
                    <div class="blog-item">
                        <div class="blog-img">
                            <div class="blog-img-inner">
                                <img class="img-fluid w-100 rounded-top" src={{ asset('img/destinations/places_1.jpeg')
                                    }} alt="Image" style="height: 400px;">
                                <div class="blog-icon">
                                    <a href={{ url('packages/1/details') }} class="my-auto"><i
                                            class="fas fa-link fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="blog-content border border-top-0 rounded-bottom p-4">
                            <a href={{ url('packages/1/details') }} class="h4">Adventures Trip</a>
                            <p class="my-3">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam
                                eos</p>
                            <a href={{ url('packages/1/details') }} class="btn btn-primary rounded-pill py-2 px-4">Mas
                                Información</a>
                        </div>
                    </div>
                </div>
                ...
                @foreach ($tours as $tour)
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <div class="blog-img-inner">
                                    <img class="img-fluid w-100 rounded-top" src={{ asset($tour['img']) }} alt="Image"
                                        style="height: 400px;">
                                    <div class="blog-icon">
                                        <a href={{ url($tour['link']) }} class="my-auto"><i
                                                class="fas fa-link fa-2x text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="blog-content border border-top-0 rounded-bottom p-4">
                                <a href={{ url($tour['link']) }} class="h4">{{ $tour['title']}}</a>
                                <p class="my-3">{{ $tour['paragraph'] }}</p>
                                <a href={{ url($tour['link']) }} class="btn btn-primary rounded-pill py-2 px-4">Mas
                                    Información</a>
                            </div>
                        </div>
                    </div>
